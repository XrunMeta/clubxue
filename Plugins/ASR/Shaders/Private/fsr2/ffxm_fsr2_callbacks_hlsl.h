...
#define FFXM_FSR2_CONSTANT_BUFFER_1_SIZE (sizeof(cbArmASR) / 4)  
...
#define FFXM_FSR2_CONSTANT_BUFFER_2_SIZE 6  
...
SamplerState s_LinearClamp : register(s1);
       ...
       Texture2D<FfxFloat32x2> r_dilated_motion_vectors : FFXM_FSR2_DECLARE_SRV(FSR2_BIND_SRV_DILATED_MOTION_VECTORS);
        ...
        Texture2D<FfxFloat32x4> r_dilated_depth_motion_vectors_input_luma : FFXM_FSR2_DECLARE_SRV(FSR2_BIND_SRV_DILATED_DEPTH_MOTION_VECTORS_INPUT_LUMA);
    #endif
    #if defined FSR2_BIND_SRV_PREV_DILATED_DEPTH_MOTION_VECTORS_INPUT_LUMA
        Texture2D<FfxFloat32x4> r_prev_dilated_depth_motion_vectors_input_luma : FFXM_FSR2_DECLARE_SRV(FSR2_BIND_SRV_PREV_DILATED_DEPTH_MOTION_VECTORS_INPUT_LUMA);
    #endif
...
void StoreReconstructedDepth(FfxUInt32x2 iPxSample, FfxFloat32 fDepth)
{
    ...
    #else
        InterlockedMin(rw_reconstructed_previous_nearest_depth[iPxSample], uDepth); 
    #endif
}
#endif
...
#elif defined(FSR2_BIND_SRV_DILATED_DEPTH_MOTION_VECTORS_INPUT_LUMA)
    return r_dilated_depth_motion_vectors_input_luma[iPxInput].x; 
#else
    return 0.0;
#endif
}
