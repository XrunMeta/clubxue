...
FDelegateHandle FEOSVoiceChat::RegisterOnVoiceChatBeforeRecvMixedAudioRenderedDelegate(
...
FDelegateHandle FEOSVoiceChat::RegisterOnVoiceChatBeforeRecvUnmixedAudioRenderedDelegate(
        const FOnVoiceChatBeforeRecvAudioRenderedDelegate::FDelegate& Delegate)
{
...
FDelegateHandle FEOSVoiceChat::RegisterOnVoiceChatBeforeRecvAudioRenderedDelegate(
        const FOnVoiceChatBeforeRecvAudioRenderedDelegate::FDelegate& Delegate)
{
