...
public:
	...
	DECLARE_MULTICAST_DELEGATE_TwoParams(FOnAudioInputDeviceStatusChanged, FString , EOS_ERTCAudioInputStatus );
	static FOnAudioInputDeviceStatusChanged OnAudioInputDeviceStatusChanged;

	DECLARE_MULTICAST_DELEGATE_FourParams(FOnVoiceChatChannelConnectionStateDelegate, const FString& , const FString& , bool , bool );
	static FOnVoiceChatChannelConnectionStateDelegate OnVoiceChatChannelConnectionStateChanged;

	DECLARE_MULTICAST_DELEGATE_FourParams(FOnVoiceChatPlayerAddedMetadataDelegate, const FString& , const FString& , const FString& , const TArray<FVoiceChatMetadataItem>& );
	static FOnVoiceChatPlayerAddedMetadataDelegate OnVoiceChatPlayerAddedMetadata;

	DECLARE_MULTICAST_DELEGATE_FourParams(FOnAudioStatusChanged, const FString& , const FString& , const FString& , const EOS_ERTCAudioStatus );
	static FOnAudioStatusChanged OnAudioStatusChanged;
};

DECLARE_MULTICAST_DELEGATE_ThreeParams(FOnVoiceChatDataReceivedDelegate, const FString& , const FString& , TArrayView<const uint8> );
