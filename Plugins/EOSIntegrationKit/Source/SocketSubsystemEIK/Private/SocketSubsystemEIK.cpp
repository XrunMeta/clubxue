...
FSocket* FSocketSubsystemEIK::CreateSocket(const FName& SocketTypeName, const FString& SocketDescription, const FName& )
{
...
FAddressInfoResult FSocketSubsystemEIK::GetAddressInfo(const TCHAR* HostName, const TCHAR* ServiceName, EAddressInfoFlags , const FName , ESocketType )
{
