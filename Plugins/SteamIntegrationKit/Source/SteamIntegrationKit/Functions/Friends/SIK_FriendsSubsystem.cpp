...
USIK_FriendsSubsystem::USIK_FriendsSubsystem()
{
	...
	if(SteamFriends() != nullptr)
	{
		...
		// m_CallbackSetPersonaNameResponse.Register(this, &USIK_FriendsSubsystem::OnSetPersonaNameResponseCallback); // UE5.8: callback unavailable
		...
		if(IsRunningDedicatedServer())
		{
			...
			// m_CallbackSetPersonaNameResponse.SetGameserverFlag(); // UE5.8: callback unavailable
...
USIK_FriendsSubsystem::~USIK_FriendsSubsystem()
{
	...
	// m_CallbackSetPersonaNameResponse.Unregister(); // UE5.8: callback unavailable
...
// UE5.8: SetPersonaNameResponse_t is unavailable in current Steamworks SDK.`r`n// void USIK_FriendsSubsystem::OnSetPersonaNameResponseCallback(SetPersonaNameResponse_t* pParam)`r`n// {`r`n//     auto Param = *pParam;`r`n//     AsyncTask(ENamedThreads::GameThread, [this, Param]()`r`n//     {`r`n//         OnSetPersonaNameResponse.Broadcast(static_cast<ESIK_Result>(Param.m_result), Param.m_bLocalSuccess, Param.m_bSuccess);`r`n//     });`r`n// }
