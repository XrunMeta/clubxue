...
namespace sl
{
	...
	{
		static_assert(uint64_t(FeatureRequirementFlags::eAll) == 31U, "dear NVIDIA plugin developer, please update this code to handle the new sl::FeatureRequirementFlags enum values");
		switch (f)
		{
